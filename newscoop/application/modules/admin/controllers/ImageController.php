...
class Admin_ImageController extends Zend_Controller_Action
{
    ...
    public function setRenditionAction()
    {
        ...
        try {
            ...
            $this->view->exception= sprintf($this->translator->trans('Sorry that image is too small. Image needs to be at least %dx%d.'), $rendition->getWidth(), $rendition->getHeight());
        }
    }
