...
public static function GetMapInfo($p_htmlDir = '', $p_websiteUrl = '', $p_mapProvider = '')
{
    ...
    foreach ($map_prov_names_arr as $one_prov_name)
    {
        ...
        {
            $one_prov_include = 'http://maps.google.com/maps/api/js?v=3.4&sensor=false';
            $one_prov_include_async = 'http://maps.google.com/maps/api/js?v=3.4&sensor=false&callback=initialize_gv3async';
    ...
    if (0 == $usage_providers_count)
    {
        ...
        $map_prov_default = 'googlev3';
        $map_prov_includes[] = 'http://maps.google.com/maps/api/js?v=3.4&sensor=false';
        $map_prov_includes_async[] = 'http://maps.google.com/maps/api/js?v=3.4&sensor=false&callback=initialize_gv3async';
        $map_prov_gv3_async_method = 'initialize_gv3async';
        $map_prov_gv3_async = true;
